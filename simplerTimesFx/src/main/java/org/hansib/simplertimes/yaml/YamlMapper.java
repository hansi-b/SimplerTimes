...
public class YamlMapper {
  ...
  public static synchronized YamlMapper instance() {
    if (instance == null) instance = new YamlMapper();
    return instance;
  }
  ...
  public <T> T fromString(final String yaml, final TypeReference<T> type)
  ...
  private static class OffsetDateTimeSerializer extends JsonSerializer<OffsetDateTime> {
    ...
    public void serialize(
        final OffsetDateTime value, final JsonGenerator gen, final SerializerProvider serializers)
        throws IOException {
  ...
  private static class SpanSerializer extends JsonSerializer<Span> {
    ...
    @Override
    public void serialize(
        final Span value, final JsonGenerator gen, final SerializerProvider serializers)
        throws IOException {
  ...
  private static class SpanStubDeserializer extends JsonDeserializer<SpanStub> {
    ...
    @Override
    public SpanStub deserialize(final JsonParser p, final DeserializationContext ctxt)
        throws IOException {
  ...
  private static class ProjectSerializer extends JsonSerializer<Project> {
    ...
    @Override
    public void serialize(
        final Project value, final JsonGenerator gen, final SerializerProvider serializers)
        throws IOException {
      ...
      for (Project c : children) gen.writeObject(c);
      gen.writeEndArray();
      gen.writeEndObject();
    }
  }
  ...
  private static class ProjectDeserializer extends JsonDeserializer<Project.Builder> {
    ...
    @Override
    public Project.Builder deserialize(final JsonParser p, final DeserializationContext ctxt)
        throws IOException {
      JsonNode node = p.readValueAsTree();
